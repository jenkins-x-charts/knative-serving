...
export JENKINS_X_URL='https://dashboard-jx.dev.jenkins-x.me/jenkins-x-charts/knative-serving/master/1'
...
export MINK_IMAGE='ghcr.io/jenkins-x/knative-serving:0.19.24'
